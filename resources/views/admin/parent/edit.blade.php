...
<div class="card">
    <form action="{{route('admins.parent.update')}}" method="post" class="p-5">
        @csrf
        ...
        <h3 class='d-flex justify-content-center'>{{$title}}</h3>
            ...
            <div class="row">
                <div class="form-group col-6">
                        ...
                        <input class="form-control" type="text" name="name" value="{{old('name')?? $parent->user_name}}" placeholder="Nhập họ và tên..." >
                    @error('name')
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <input class="form-control" type="text" name="occupation" value="{{old('occupation') ?? $parent->occupation}}"  placeholder="VD: Giáo viên" >
                    @error('occupation')
                    <span style="color: red" class="text-sm">{{$message}}</span>
                    @enderror
                </div>
                ...
                <div class="form-group col-6">
                        ...
                        <input class="form-control" type="text" name="nation" value="{{old('nation') ?? $parent->nation}}"  placeholder="VD: Không" >
                        @error('nation')
                        <span style="color: red" class="text-sm">{{$message}}</span>
                        @enderror
                </div>
            ...
            {{-- 1 --}}
              <div class="form-group col-6">
                ...
                <select class="form-control" name='status'>
                    ...
                    <option value='0' {{ $parent->user_status =='0'?'selected':''}}>Xuất hiện</option>
                    <option value='1' {{ $parent->user_status =='1'?'selected':''}}>Ẩn</option>
            ...
            <input type="hidden" value="{{$parent->user_id}}" name='user_id'>
            <div class="container">
